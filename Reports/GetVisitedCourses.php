...
namespace Piwik\Plugins\Chamilo\Reports;
 ...
 */
class GetVisitedCourses extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('Chamilo_VisitedCourses');
        $this->dimension     = null;
        $this->documentation = Piwik::translate('Number of visits by course');
        ...
        $this->menuTitle    = 'Visited courses';
        ...
        $this->widgetTitle  = 'Visited courses';
    }
    ...
    {
        $view = new View('@Chamilo/getVisitedCourses');
        $view->myData = array();
